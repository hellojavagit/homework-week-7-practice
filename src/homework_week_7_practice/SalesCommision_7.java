...
public class SalesCommision_7 {
    public static void main(String[] args) {
        ...
        SalesCommision_7 salesCommision = new SalesCommision_7();
        int grossSalary = basicSalary + salesCommision.calculateCommision(salesAmount);
    ...
    public int calculateCommision( int salesAmount){
        ...
        if(salesAmount >= 50000) {
            ...
            System.out.println("Sakles Commission is " + commission);
        }
        return commission;
